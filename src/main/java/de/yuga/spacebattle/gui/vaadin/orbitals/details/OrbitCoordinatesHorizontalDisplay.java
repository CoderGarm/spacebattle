 ...
 */
public class OrbitCoordinatesHorizontalDisplay extends HorizontalLayout implements HasValue<AbstractField.ComponentValueChangeEvent<OrbitCoordinatesHorizontalDisplay, Orbit>, Orbit> {
    ...
    public OrbitCoordinatesHorizontalDisplay() {
    ...
    @Override
    public Registration addValueChangeListener(ValueChangeListener<? super AbstractField.ComponentValueChangeEvent<OrbitCoordinatesHorizontalDisplay, Orbit>> listener) {
        // not necessary
        return null;
    }
