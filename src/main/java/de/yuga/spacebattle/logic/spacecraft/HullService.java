...
import de.yuga.spacebattle.repositories.spacecraft.HullRepository;
...
public class HullService {
    ...
    public Hull createHull(@Nonnull final String name,
        ...
        return hullRepository.save(new Hull(name, level, constructionCapacity, description, unlockedThrough));
    }
