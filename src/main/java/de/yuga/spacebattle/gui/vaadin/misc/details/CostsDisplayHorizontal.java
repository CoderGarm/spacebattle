 ...
 */
public class CostsDisplayHorizontal extends HorizontalLayout implements HasValue<AbstractField.ComponentValueChangeEvent<CostsDisplayHorizontal, ResourceDeposit>, ResourceDeposit> {

    @Nonnull
    private final CostsDisplayDatasource datasource;

    public CostsDisplayHorizontal(@Nonnull final EResolution resolution) {
    ...
    @Override
    public Registration addValueChangeListener(ValueChangeListener<? super AbstractField.ComponentValueChangeEvent<CostsDisplayHorizontal, ResourceDeposit>> listener) {
        return null;
    }
