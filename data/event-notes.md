...
Operation Sunflower once wiped out all known naval bases of the Kersey Association, the main pirate organization in the galaxy populated by humans.

Despite Sunflower was quite effective and all main goals and targets were reached.  
Those who remained withdrew and things became quiet around Kersey. It was a misleading peaceful time.

The Kersey Association, bleeding and battered, tried to expand by other means.  
They penetrated civil society through diplomatic channels and corrupted some single system nations.

The **I**nterstellar **N**aval **T**askforce for **E**radicating **R**ogue **C**orsair **P**resence (**INTERCEPT**) calls out Operation War Harvest.

The main goal of this operation is to wipe out the withstanding pirate forces, their new homes and their shipyard infrastructure.

##### Rules

- Every participating fleet have to be placed in the home system of the owner at the first tick of the event.
- The participating fleet's name have to begin with ***INTERCEPT*** and must not be changed during the event.
- It is not allowed to reinforce fleets from other, non-participating fleets.   
  This rule should prevent the situation that a fleet next to a popup naval base can support the attacking INTERCEPT fleet.
- It is not allowed to attack the operations goal in order to wipe out resistance and capture the planet with the INTERCEPT fleet afterwards.
- INTERCEPT is an international organized events and strictly limited to the participating fleets.  
...
- In a time frame of two weeks, every fleet with that name can conquer a planet by entering the orbit of an inactive player's planet or popup naval base first and alive.  
  The conquered planet need to be indicated by a forum post in the corresponding thread.

It would be nice if there is a little fluff in it. Strong emotions, flying missiles and losing the reactor's the containment are accepted favorably.  
...
4. Every interested player without enough hyper-space capable ships can send me a PM with an amount of warships by class up to 170 k tons - twice the initial fleet.
5. Kersey's naval bases will be shown on the map for the timeframe. They have bigger fleets and a bigger gain.
