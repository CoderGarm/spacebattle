...
public class DistanceCalculatorTest {
    ...
    public void testCalculateDistance(final Fleet fleet, final Planet planet, final int expectation) {
        ...
        assertEquals(expectation, calculateDistance);
    }
    ...
    private static Stream<Arguments> testCalculateTimeToTravel() {
        final Planet planet = planet(0, 0);
        return Stream.of(
                Arguments.of(fleet(500, planet), new FleetOrbit(Orbit.getCenterOrbit(), system(25, 25)), 1),
                Arguments.of(fleet(500, planet), new FleetOrbit(Orbit.getCenterOrbit(), system(50, 50)), 2),
                Arguments.of(fleet(500, planet), new FleetOrbit(Orbit.getCenterOrbit(), system(1125, 1130)), 40)
        );
    }
    ...
    private static Stream<Arguments> testGetDistanceAsStringWithUnitProvider() {
        return Stream.of(
                ...
                Arguments.of(bd("9454254955488000"), "1 ly"),
                Arguments.of(bd("30856776000000000"), "1 pc"),
                Arguments.of(bd("1495978707000"), "1.39 lh"),
                Arguments.of(bd("10792528488000"), "0.42 ld"),
                Arguments.of(bd("259020683712000"), "0.03 ly"),
