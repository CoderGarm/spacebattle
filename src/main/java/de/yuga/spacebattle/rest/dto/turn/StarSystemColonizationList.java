...
public class StarSystemColonizationList extends ArrayList<StarSystemColonization> {

    public StarSystemColonizationList(@Nonnull final Collection<StarSystem> allSystems,
