...
public class ColonizationCostCalculator {
     ...
     * @return the costs
     */
    public static ResourceCostAmountDTO calculateInformationCost(@Nonnull final StarSystem starSystem) {
        ...
        return new ResourceCostAmountDTO(EResourceType.CREDITS, cost.longValue());
    }
     ...
     * @return the costs
     */
    public static ResourceCostAmountDTO calculateColonizationCost(@Nonnull final Planet planet) {
