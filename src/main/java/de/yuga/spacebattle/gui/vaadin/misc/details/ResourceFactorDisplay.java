 ...
 */
public class ResourceFactorDisplay extends HorizontalLayout {

    @Nonnull
    private final Map<EResourceType, ResourceElementDisplay> componentMap = new HashMap<>();

    public ResourceFactorDisplay(@Nonnull final ResourceDeposit resourceDeposit) {
        ...
        Arrays.stream(EResourceType.values()).forEach(resourceType -> {
            ...
            resourceElementDisplay.updateAmount(new ResourceAmountWrapper(amount, null));
