...
public class HullByAmountVerticalDisplay extends VerticalLayout implements HasValue<AbstractField.ComponentValueChangeEvent<HullByAmountVerticalDisplay, Map<ShipClass, Integer>>, Map<ShipClass, Integer>> {
    ...
    @Override
    public Registration addValueChangeListener(ValueChangeListener<? super AbstractField.ComponentValueChangeEvent<HullByAmountVerticalDisplay, Map<ShipClass, Integer>>> listener) {
        // not necessary
        return null;
    }
