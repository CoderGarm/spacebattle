...
1. **Reserve Fleet:** First, you need to maintain an active reserve fleet in your local system. This reserve fleet serves as a pool of ships that can be dispatched to protect your
   convoys. Ensure that you have enough ships in this fleet to cover the convoy's needs.

2. **Equip a Mission:** Next, select the ships you wish to assign to convoy protection from your reserve fleet. These ships will be responsible for guarding the convoy. Equip them
   with the "Convoy Protection" mission.

3. **Assign to Convoy:** With the mission assigned, you can now assign these protected ships to the trade convoy you want to safeguard. This can be done during the initial tick of
   the convoy's journey. The protection mission will help deter pirate attacks and ensure the safe passage of the convoy.
...
1. **Reserveflotte:** Zuerst musst du in deinem lokalen System eine aktive Reserveflotte unterhalten. Diese Reserveflotte dient als Pool von Schiffen, die zur Absicherung deiner
   Konvois eingesetzt werden können. Stelle sicher, dass genügend Schiffe in dieser Flotte sind, um die Anforderungen des Konvois zu erfüllen.

2. **Mission ausrüsten:** Wähle nun die Schiffe aus deiner Reserveflotte aus, die du dem Konvoischutz zuweisen möchtest. Diese Schiffe sind für die Bewachung des Konvois
   verantwortlich. Rüste sie mit der Mission "Konvoischutz" aus.

3. **Dem Konvoi zuweisen:** Mit der zugewiesenen Mission kannst du diese geschützten Schiffe jetzt dem Handelskonvoi zuweisen, den du schützen möchtest. Dies kann während des
   ersten Ticks der Reise des Konvois erfolgen. Die Schutzmission wird dazu beitragen, Piratenangriffe abzuschrecken und die sichere Passage des Konvois sicherzustellen.
