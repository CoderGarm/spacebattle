...
public class ModuleApi extends BaseApi {
    ...
    public static final String ARMOR_ENDPOINT = "armor";
    public static final String WEAPON_ENDPOINT = "weapon";
    public static final String LAUNCHER_ENDPOINT = "launcher";
    public static final String SIDEWALL_ENDPOINT = "sidewall";
