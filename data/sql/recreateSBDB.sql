...
alter table ownedPlanet
    drop
        foreign key FKn0py0rp0q5d6ifuucyhb3xyhj;

alter table ownedPlanet
    drop
        foreign key FKpjrykkx2r1d5p6xohg6fy7hdq;
...
alter table ownedPlanet
    add constraint FKn0py0rp0q5d6ifuucyhb3xyhj
        foreign key (idPlanet)
            references planet (idPlanet);

alter table ownedPlanet
    add constraint FKpjrykkx2r1d5p6xohg6fy7hdq
        foreign key (idUser)
            references user (idUser);
